...
def sleepnet_collate(batch: list) -> dict:
	...
	# remove all non-ecg information
        sample_additional = torch.randn_like(sample_additional)
        night = torch.randn_like(night)
        midnight_vec = torch.randn_like(midnight_vec)
